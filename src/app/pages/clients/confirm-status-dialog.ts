    ...
    <div class="csd-overlay">
      <div class="csd-card" [class.csd-activate]="data.activate" [class.csd-deactivate]="!data.activate">
        ...
        <p class="csd-message">
          ...
          le client <strong>{{ data.clientName }}</strong> ?
        </p>
...
export class ConfirmStatusDialogComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<ConfirmStatusDialogComponent, boolean>,
  ...
  confirm(): void {
    ...
    // Resolve with true — the caller handles the API call
