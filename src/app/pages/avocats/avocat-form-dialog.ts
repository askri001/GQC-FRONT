...
export interface AvocatFormDialogData {
  prestataire?: Prestataire;
  isEdit: boolean;
}

@Component({
  selector: 'app-avocat-form-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
    ...
    <div class="dialog-container">
      <div class="dialog-header">
        <h2 mat-dialog-title>
          ...
          {{ data.isEdit ? 'Modifier Avocat' : 'Nouvel Avocat' }}
        </h2>
...
export class AvocatFormDialogComponent implements OnInit {
  form!: FormGroup;
  isLoading = false;
  specialites = PRESTATAIRE_SPECIALITES['AVOCAT' as TypePrestataire];

  constructor(
    private fb: FormBuilder,
    public dialogRef: MatDialogRef<AvocatFormDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: AvocatFormDialogData
  ) {}
  ...
  onSubmit(): void {
    if (this.form.valid) {
      ...
      const prestataireData: Partial<Prestataire> = {
        ...formValue,
        typePrestataire: 'AVOCAT' as TypePrestataire
      };
