...
export interface PrestataireFormDialogData {
    ...
    <div class="dialog-container">
      <div class="dialog-header">
        <h2 mat-dialog-title>
          ...
          {{ data.isEdit ? 'Modifier Prestataire' : 'Nouveau Prestataire' }}
        </h2>
...
export class PrestataireFormDialogComponent implements OnInit {
  form!: FormGroup;
  isLoading = false;
  specialites = ['Général', 'Spécifique', 'Technique']; // Generic for all prestataires

  constructor(
    private fb: FormBuilder,
    public dialogRef: MatDialogRef<PrestataireFormDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: PrestataireFormDialogData
  ) {}
